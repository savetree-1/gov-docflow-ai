...
/****** Configuring multer for profile photo uploads ******/
...
router.post('/login', async (req, res) => {
  try {
    ...
    /****** Checking if the user is active and approved ******/
    if (!user.isActive) {
    ...
    /****** Verifying the password for auth******/
...
router.post('/refresh', async (req, res) => {
  try {
    ...
    /****** Taking user to include latest role and department ******/
...
router.get('/me', authMiddleware, async (req, res) => {
  try {
    ...
    /****** Conversion to plain object and add full URL for profile photo storage******/
...
/****** Put Endpoint for update user profile functionality ******/
...
/****** Put Endpoint for Change password ******/
...
/****** Put Endpoint for Upload profile photo ******/

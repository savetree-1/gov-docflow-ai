...
async function testCompleteFlow() {
  ...
  try {
    // Step 1: Login
    console.log('\n1️⃣ Logging in as Finance Admin...');
    ...
    // Step 2: Get Users
    console.log('\n2️⃣ Fetching users with this token...');
    ...
    if (users.length === 0) {
      console.log('⚠️  NO USERS RETURNED - This is the problem!');
      console.log('\nPossible reasons:');
    ...
    console.log('\n3️⃣ For comparison, fetching as Super Admin...');
